...
namespace Simulation.Models
{
    public static class SpectrumParameterConverter
    {
        ...
        private static readonly Dictionary<SpectrumParameterType, Func<double, double>> ConvertFromType = 
            new Dictionary<SpectrumParameterType, Func<double, double>>
        {
        ...
        private static readonly Dictionary<SpectrumParameterType, Func<double, double>> ConvertToType = 
            new Dictionary<SpectrumParameterType, Func<double, double>>
        {
            { SpectrumParameterType.CycleFrequency, v => v },
